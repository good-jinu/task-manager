...
import { Check, Close, Home, Plus, Settings, Sparkles } from "./icons";
...
const steps = [
	{
		...
		description:
			"Manage your tasks efficiently with AI assistance. Let's take a quick tour of your new workspace.",
		icon: Home,
		color: "text-primary",
		bg: "bg-primary/10",
	},
	{
		...
		description:
			"Use the 'Add Task' button to quickly jot down what you need to do. You can add titles, descriptions, and more.",
		icon: Plus,
		color: "text-success",
		bg: "bg-success/10",
	...
	},
	{
		...
		description:
			"Use the AI input at the bottom to ask for help, summarize tasks, or even generate new ones automatically.",
		icon: Sparkles,
		color: "text-accent",
		bg: "bg-accent/10",
	...
	},
	{
		...
		description:
			"Open settings to connect Notion, manage your workspaces, or create an account to save your tasks permanently.",
		icon: Settings,
		color: "text-info",
		bg: "bg-info/10",
